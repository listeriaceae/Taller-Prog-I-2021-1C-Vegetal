...
const GameOverState *GameOverState::getInstance() { return &instance; }

void GameOverState::reset(Mario &) const {}

bool GameOverState::isAlive() const { return false; }

bool GameOverState::isPlaying() const { return false; }
